	...
	public class ID3v1
	{
		...
		public string Title
		{
			...
			set
			{
				if (value.Length > 30)
				{
					_Title = value.ToString().Remove(30);
				}
				else
				{
					_Title = value;
		...
		public string Artist
		{
			...
			set
			{
				if (value.Length > 30)
				{
					_Artist = value.ToString().Remove(30);
				}
				else
				{
					_Artist = value;
		...
		public string Album
		{
			...
			set
			{
				if (value.Length > 30)
				{
					_Album = value.ToString().Remove(30);
				}
				else
				{
					_Album = value;
		...
		public string Comment
		{
			...
			set
			{
				if (value.Length > 28)
				{
					_Comment = value.ToString().Remove(28);
				}
				else
				{
					_Comment = value;
